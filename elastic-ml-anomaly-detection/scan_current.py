...
Cloud/Serverless instead -- see ../RUNNING_ON_ELASTIC_CLOUD.md. Note the
jobs themselves (jobs/*.json) must already exist on that cluster -- see
that doc's detector-setup section for the `elastic es ml put-job` steps.
"""
import argparse
import base64
import json
