...
[`RUNNING_LOCALLY.md`](RUNNING_LOCALLY.md) (self-hosted, no cloud
account), or [`RUNNING_ON_ELASTIC_CLOUD.md`](RUNNING_ON_ELASTIC_CLOUD.md)
(same demo + detectors, pointed at a real Elastic Cloud/Serverless
deployment).
